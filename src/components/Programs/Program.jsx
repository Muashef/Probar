    ...
    <div className='w-full h-full px-14 pt-52 mx-auto bg-[#F0EEEB]'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 place-content-center gap-4 mt-10 px-10'>
            <div className='bg-white border border-[#2B34B3] p-5 w-[577px] z-10'>
                ...
                <p className='text-[#474A4D] font-normal text-xl mt-3'>With our comprehensive beginner training, learn all the essential skillset and techniques to excel in this dynamic field. No prior knowledge and experience in Product Management needed.</p>
            ...
            <div className='bg-white border border-[#041143] p-5 w-[577px]'>
                ...
                <p className='text-[#474A4D] font-normal text-xl mt-3'>Students will learn advanced skills and techniques for product development and strategy. The program is designed for professionals who are looking to take their skills to the next level.</p>
