       ...
       <div className='py-16'>
            ...
            <div className='w-full flex gap-10 overflow-x-scroll custom-scrollbar mt-10'>
                <div className='w-[577px] flex-shrink-0 bg-conic border-4 border-[#FDFCFC] p-5'>
                    ...
                    <button className='flex items-center gap-2 mt-6 w-[fit-content] py-[0.4475rem] px-4 text-[#452F9D] text-base bg-white border border-[#452F9D] font-bold rounded-md md:py-[11px] md:px-3 hover:border-2 hover:border-[#ECE9E6] hover:scale-105 hover:text-xl transform transition-all duration-700'>
                ...
                <button className='flex items-center gap-2 mt-6 w-[fit-content] py-[0.4475rem] px-4 text-[#015967] text-base bg-[#ECE9E6] border border-[#452F9D] font-bold rounded-md md:py-[11px] md:px-3 hover:scale-105 hover:text-xl transform transition-all duration-700'>
                ...
                <button className='flex items-center gap-2 mt-6 w-[fit-content] py-[0.4475rem] px-4 text-[#452F9D] text-base bg-white border border-[#452F9D] font-bold rounded-md md:py-[11px] md:px-3 hover:scale-105 hover:text-xl transform transition-all duration-700'>
